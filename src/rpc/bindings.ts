...
rsvp: (calendarSlug: string, eventId: string, response: string, scope: string) => Promise<null>, 
...
sync_calendar: (calendarSlug: string) => Promise<null>, 
...
get_start_at_login: () => Promise<boolean>, 
get_start_minimized: () => Promise<boolean>, 
...
set_start_at_login: (enabled: boolean) => Promise<null>, 
