  ...
  return (
    <SelectPrimitive.Trigger
      ...
      className={cn(
        ...
        // Non-ghost (form) variant: a clearly filled, bordered control so it
        // reads as an obvious dropdown across all themes instead of blending
        // into the page background.
        { "border-input bg-secondary hover:bg-secondary-hover shadow-xs": !ghost },
        className,
      )}
      {...props}
    >
